...
import { FaHome, FaServer, FaLink, FaFlask } from 'react-icons/fa';
...
function Sidebar({ isOpen, toggle, onLogout }) {
  ...
  const navItems = [
    ...
    },
    {
      href: '/riset',
      label: 'Riset',
      icon: <FaFlask className="h-6 w-6 flex-shrink-0" />,
    },
    {
      href: '/links',
      label: 'Distribusi Link',
      icon: <FaLink className="h-6 w-6 flex-shrink-0" />,
    },
  ];
      ...
      <div>
        <button 
          ...
          className={`
            ...
            ${!isOpen && 'justify-center'}
          `}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24" stroke="currentColor" strokeWidth={2}>
